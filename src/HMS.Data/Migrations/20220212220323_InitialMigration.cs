        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmentyId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomAmenties", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomAmenties_Amenties_AmentyId",
                        column: x => x.AmentyId,
                        principalTable: "Amenties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomAmenties_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomAmenties_AmentyId",
                table: "RoomAmenties",
                column: "AmentyId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomAmenties_RoomId",
                table: "RoomAmenties",
                column: "RoomId");
